...
ALERTS
<div class="pwd-wrap"><input type="password" name="access_pwd" placeholder="密码" autocomplete="current-password" autofocus><button type="button" class="pwd-toggle" tabindex="-1" onclick="var i=this.previousElementSibling,e=this.querySelector('use');if(i.type==='password'){i.type='text';e.setAttribute('href','#eye-off')}else{i.type='password';e.setAttribute('href','#eye')}" aria-label="切换密码显示"><svg><use href="#eye"/></svg></button></div>
